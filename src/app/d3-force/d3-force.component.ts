...
export class D3ForceComponent implements OnInit {
  ...
  private buildSvg() {
    ...
    this.svg = d3.select('figure#force').append('svg')
      .attr("width", 1024)
      .attr("height", 600)
 ...
 */
  ...
  //    label.attr("transform", (d:any) => `translate(${d.x+6}, ${d.y+3})`)
