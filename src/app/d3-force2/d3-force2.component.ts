...
@Component({
  selector: 'app-d3-force2',
  templateUrl: './d3-force2.component.html',
  styleUrls: ['./d3-force2.component.css']
})
export class D3Force2Component implements OnInit {
