 ...
 */
  ...
  constructor() {
/*
    this.jsonObject = <JSON>this.tmp

    this.links = this.tmp.links.map((d:any)=>Object.create(d))
   this.nodes = this.tmp.nodes.map((d:any)=>Object.create(d))
